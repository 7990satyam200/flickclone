...
from django.http import HttpRespo«nse
...
def search(request):
    ...
    allowing WholeSaler to buy harvested crops.
    """
...
def seller_buy(request, pk, topic_pk):
    ...
    and then accepting details regarding placing order.
    finally WholeSalers can see their order placed.
    """
    brought = False
